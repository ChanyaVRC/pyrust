"""
Parity fixture: del module.__dict__ raises AttributeError: readonly attribute
(issue #1665).

CPython 3.12: __dict__ on a module object is a read-only slot exposed via
PyModuleObject.md_dict; attempting to delete it raises
AttributeError('readonly attribute').  pyrust previously raised
